 ...
 */
public class Asteroid extends Participant implements ShipDestroyer, MyBulletDestroyer, AlienDestroyer, AlienBulletDestroyer
{
    ...
    public void collidedWith (Participant p)
    {
        if (p instanceof AsteroidDestroyer)
        {
            ...
            if (this.getSize() == 1)
            {
                ...
                controller.addParticipant(new Asteroid(RANDOM.nextInt(3), 0, this.getX(), this.getY(),
                        RANDOM.nextInt(2) + 4, controller));
                controller.addParticipant(new Asteroid(RANDOM.nextInt(3), 0, this.getX(), this.getY(),
                        RANDOM.nextInt(2) + 4, controller));
            ...
            if (this.getSize() == 2)
            {
                controller.addParticipant(new Asteroid(RANDOM.nextInt(3), 1, this.getX(), this.getY(),
                        RANDOM.nextInt(2) + 3, controller));
                controller.addParticipant(new Asteroid(RANDOM.nextInt(3), 1, this.getX(), this.getY(),
                        RANDOM.nextInt(2) + 3, controller));
